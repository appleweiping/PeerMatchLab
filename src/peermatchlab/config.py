    ...
    def __post_init__(self) -> None:
        ...
        if self.strategy not in {
            ...
            raise DataValidationError(
                "strategy must be 'optimal', 'greedy', 'minmax', 'maximin', "
                "'maximin-flow', or 'fair-local'"
            )
        ...
        if self.strategy == "maximin-flow" and self.load_balance_penalty:
            raise DataValidationError("maximin-flow does not support load_balance_penalty")
